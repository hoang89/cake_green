...
public abstract class QuickActionWidget extends PopupWindow {
    ...
    public void setContentView(int layoutId) {
    	View root = LayoutInflater.from(mContext).inflate(layoutId, null);
        setContentView(root);
    ...
    private void showArrow() {
        ...
        final View content = contentView.findViewById(R.id.gdi_quick_action_items);
        ...
        param.leftMargin = mRect.centerX() - (arrow.getMeasuredWidth()) ;
        param.bottomMargin = mScreenHeight - mRect.centerY() + mArrowOffsetY;
    }
